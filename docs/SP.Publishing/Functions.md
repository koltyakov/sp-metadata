...
ProcessSourcePageAfterPageMovePublish (SP.Publishing.CampaignPublication) | ✅ | ❌ | ❌ | ❌
ProcessSourcePageAfterPageMovePublish (SP.Publishing.FeedVideoPage) | ✅ | ❌ | ❌ | ❌
ProcessSourcePageAfterPageMovePublish (SP.Publishing.RepostPage) | ✅ | ❌ | ❌ | ❌
ProcessSourcePageAfterPageMovePublish (SP.Publishing.SitePage) | ✅ | ❌ | ❌ | ❌
ProcessSourcePageAfterPageMovePublish (SP.Publishing.SitePage3D) | ✅ | ❌ | ❌ | ❌
ProcessSourcePageAfterPageMovePublish (SP.Publishing.TopicSitePage) | ✅ | ❌ | ❌ | ❌
ProcessSourcePageBeforePageMovePublish (SP.Publishing.CampaignPublication) | ✅ | ❌ | ❌ | ❌
ProcessSourcePageBeforePageMovePublish (SP.Publishing.FeedVideoPage) | ✅ | ❌ | ❌ | ❌
ProcessSourcePageBeforePageMovePublish (SP.Publishing.RepostPage) | ✅ | ❌ | ❌ | ❌
ProcessSourcePageBeforePageMovePublish (SP.Publishing.SitePage) | ✅ | ❌ | ❌ | ❌
ProcessSourcePageBeforePageMovePublish (SP.Publishing.SitePage3D) | ✅ | ❌ | ❌ | ❌
ProcessSourcePageBeforePageMovePublish (SP.Publishing.TopicSitePage) | ✅ | ❌ | ❌ | ❌
