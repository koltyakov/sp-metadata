...
GetLastestVersionsInDescendingOrder (SP.Publishing.CampaignPublication) | ✅ | ❌ | ❌ | ❌
GetLastestVersionsInDescendingOrder (SP.Publishing.FeedVideoPage) | ✅ | ❌ | ❌ | ❌
GetLastestVersionsInDescendingOrder (SP.Publishing.RepostPage) | ✅ | ❌ | ❌ | ❌
GetLastestVersionsInDescendingOrder (SP.Publishing.SitePage) | ✅ | ❌ | ❌ | ❌
GetLastestVersionsInDescendingOrder (SP.Publishing.SitePage3D) | ✅ | ❌ | ❌ | ❌
GetLastestVersionsInDescendingOrder (SP.Publishing.TopicSitePage) | ✅ | ❌ | ❌ | ❌
